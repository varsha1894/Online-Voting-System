...
<h2 class="text-center  wowload fadeInUp">Get in touch to start your Voting</h2>
  <div class="row wowload fadeInLeftBig">      
      ...
      <div class="col-sm-4 col-sm-offset-4 col-xs-12">  
        ...
        <form:form method="POST" action="/onlinevoting/SubmitLogin" modelAttribute="login" >	 
        <input type="text"  placeholder="Website" name="website" id="textboxshadow">
   ...
   <!--     <textarea rows="5" placeholder="Message"></textarea>   -->
        ...
        <br/>
        <p id="clickhere"> To Sign up,<a href="organizer"> Click Here</a></p>
