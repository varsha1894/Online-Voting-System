...
<h2 class="text-center  wowload fadeInUp">Get in touch to start your Voting</h2>
  <div class="row wowload fadeInLeftBig">      
      <div class="col-sm-4 col-sm-offset-4 col-xs-12">  
        ...
        <form:form method="POST" action="/onlinevoting/VoterSubmit" modelAttribute="voter" >	    
		<input type="text" placeholder="Website" name="website" value="${website}" readonly>
        <input type="text" placeholder="Name" name="name" onChange="return pname();" id="f" required>
        <p id="demo" style="color:#F00"></p>
        <input type="email" placeholder="Email" name="email" id="email" required >
		 <input type="text" placeholder="Phone" name="phone" id="ph" onChange="return validateph(); ">
		 <p id="pph" style="color:#F00"></p>
		<input type="password" placeholder="Password(Max length 16)" name="password" maxlength="16" id="txtpwd">
		<input type="password" placeholder="Confirm Password" name="CPassword" id="txtcpwd" onChange="return validate();">
